...
def main():
  ...
  model.setTimeUnit(CUnit.d)
  model.setVolumeUnit(CUnit.dimensionlessVolume)
  model.setQuantityUnit(CUnit.quantity)
...
#  reaction.addParameterObject("substrate", adp)
  ...
  dataModel.saveModel("created_model.cps", True)

  # export the model to an SBML file
  # we save to a file named example1.xml, we want to overwrite any
  # existing file with the same name and we want SBML L2V3
  dataModel.exportSBML("created_model.xml", True, 2, 3)
